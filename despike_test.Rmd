...
plt_n0.1 <- d %>%
  ...
  theme_bw()
ggsave(filename = paste0(var,"_plt_n0.1.png"), plt_n0.1, dpi=100)
...
plt_n0.5 <- d %>%
  ...
  facet_wrap(vars(params), ncol = 1) +
  theme_bw()
ggsave(filename = paste0(var,"_plt_n0.5.png"), plt_n0.5, dpi=100)
...
plt_n1 <- d %>%
  ...
  facet_wrap(vars(params), ncol = 1) +
  theme_bw()
ggsave(filename = paste0(var,"_plt_n1.png"), plt_n1, dpi=100)
...
plt_n2 <- d %>%
  ...
  facet_wrap(vars(params), ncol = 1) +
  theme_bw()
ggsave(filename = paste0(var,"_plt_n2.png"), plt_n2, dpi=100)
}
plot_despike(data = res, var = "data$PCO2_corr_contros")
```

![alt text here](plt_n0.1.png)
![alt text here](plt_n0.5.png)

![alt text here](plt_n1.png)
![alt text here](plt_n2.png)
...
tmp <- agg_hour(data = res, var = "PCO2_corr_contros")
d_hour <- tmp[[1]]
